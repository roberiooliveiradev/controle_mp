 ...
 * Retorna: { fields: {key:msg}, suppliers: {rowIdx:{colKey:msg}} }
 */
...
/**
 * Converte fields vindos do backend (array) para um "form state" (por tags)
 * e preserva o id de cada field (para update).
 *
 * Retorna:
 * {
 *   byTag: { tag: { id, field_type_id, field_value } },
 *   values: { tag: valueString },
 *   fornecedoresRows: [...],
 * }
 */
...
/**
 * Gera o novo field_value JSON de fornecedores.
 */
...
// --- NOVO: validação para edição (valuesByTag + fornecedoresRows) ---
// Mesma regra do validateStructuredItem, mas lendo do form por tags.
