...
export const TEXT_FIELD_TAGS = Object.freeze(
	Object.values(TAGS).filter((tag) => tag !== TAGS.fornecedores),
);

export { planTextFieldPersistence } from "./requestItemFieldPersistence";
